            ...
            <div class="w-full py-4">
                <div class="" >
                    ...
                    <div class="mt-2">
                        ...
                        <div class="px-3 mt-1 border-2 border-gray-300 w-full rounded-xl h-10">
                            <input v-model="checkPassword" class="outline-0 w-full h-full" type="password" name="" placeholder="Min 6 character" >
                        </div>
                    </div>
                    <button class="w-full bg-mypink text-white py-2 mt-8 rounded-xl" @click="register()" type="submit">Create Account</button>
                </div>
